...
import { FarmExecution } from "./FarmExecution";
  ...
  private completeConstruction() {
    ...
    switch (this.constructionType) {
      ...
      case UnitType.Factory:
        ...
        break;
      case UnitType.Farm:
        this.mg.addExecution(new FarmExecution(this.structure!, player));
        break;
      case UnitType.OilRig:
        this.mg.addExecution(new OilRigExecution(this.structure!, player));
        break;
      default:
        console.warn(
